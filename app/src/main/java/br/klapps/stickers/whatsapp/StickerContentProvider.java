package br.klapps.stickers.whatsapp;
...
public class StickerContentProvider extends ContentProvider {
    ...
    public static final String CONTENT_PROVIDER_AUTHORITY = "br.klapps.stickers.whatsapp.StickerContentProvider";
    ...
    public boolean onCreate() {
        ...
        for (StickerPack stickerPack : getStickerPackList()) {
            ...
            Log.i(TAG, STICKERS_ASSET + "/" + stickerPack.identifier + "/" + stickerPack.trayImageFile);
            ...
            if (stickerPack.getStickers() != null) {
                for (Sticker sticker : stickerPack.getStickers()) {
                    Log.i(TAG, STICKERS_ASSET + "/" + stickerPack.identifier + "/" + sticker.imageFileName);
    ...
    private AssetFileDescriptor fetchFile(@NonNull Uri uri, @NonNull AssetManager am, @NonNull String fileName, @NonNull String identifier) {
        try {
            String stickerPath = Environment.getExternalStoragePublicDirectory(
                    ...
                    .concat("/Stickers");
            File file = new File(stickerPath + "/" + identifier + "/", fileName);
    ...
    public List<StickerPack> getStickerPackList() {
        return Hawk.get("sticker_packs", new ArrayList<>());
    }
